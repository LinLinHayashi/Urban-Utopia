...
const userSlice = createSlice({ 
  ...
  reducers: {
    ...
    signInSuccess: (state, action) => { // Action is a JS object.
      state.currentUser = action.payload; // "payload" is an attribute of an action, which is the value passed with the action. Another action attribute is "type".
      state.loading = false;
      state.error = null;
    },
...
// We only need to import this in "store.js" file to hook this slice with the store.
