        ...
        <div>
          ...
          <div className='fixed top-[13%] right-[3%] z-10 border rounded-full w-12 h-12 flex justify-center items-center bg-slate-100 cursor-pointer'>
            <FaShare className='text-slate-500' onClick={() => {
              navigator.clipboard.writeText(window.location.href); // Take the URL of the current webpage using "window.location.href" and use "navigator.clipboard.writeText()" to write this URL to the clipboard.
              setCopied(true);
              setTimeout(() => {
                setCopied(false);
              }, 2000);
