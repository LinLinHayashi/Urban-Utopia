...
export default function Search() {
  ...
  useEffect(() => {
    ...
    // Changes of the URL will change the side bar data.
    ...
    const fetchListings = async () => {
      ...
      const data = await res.json(); // Note that "data" is an array of listings.
      if (data.length > 8){
        setShowMore(true);
      }
      setListings(data);
  ...
  const handleSubmit = e => {
    ...
    // Changes of the side bar data will change the URL.
